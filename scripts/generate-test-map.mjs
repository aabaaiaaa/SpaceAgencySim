...
const E2E_SPEC_AREAS = {
  ...
  'e2e/auto-save-launchpad.spec.ts':      ['core/saveload', 'ui/utilities', 'ui/launchPad'],
  ...
  'e2e/perf-overlay-drag.spec.ts':        ['core/perfMonitor', 'ui/settings'],
  'e2e/flight-settings.spec.ts':          ['ui/settings', 'ui/flightController'],
