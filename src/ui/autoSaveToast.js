/**
 * autoSaveToast.js — Auto-save toast notification with cancel button.
 *
...
/** @type {HTMLElement|null} Currently visible toast element. */
let _activeToast = null;

/** @type {number|null} Timer ID for the pending auto-save. */
 ...
 * @param {string} [trigger]  Label for the trigger source (e.g. 'post-flight').
 */
export function triggerAutoSave(state, _trigger) {
 ...
 */
export function autoSaveImmediate(state) {
