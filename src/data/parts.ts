...
export const PARTS: PartDef[] = [
...

  {
    ...
    description: 'Large-capacity bulk storage for solid resources. Reinforced frame with double capacity.',
    type: PartType.MINING_MODULE,
    reliability: RELIABILITY_TIERS.MID,
    mass: 800,
    cost: 30_000,
...

  {
    ...
    description: 'High-pressure storage for gaseous resources. Enhanced containment with improved capacity.',
    type: PartType.MINING_MODULE,
    reliability: RELIABILITY_TIERS.MID,
    mass: 600,
    cost: 45_000,
...

  {
    id: 'fluid-tank-mk2',
    name: 'Fluid Tank Mk2',
    description: 'Insulated tank for liquid resources. Upgraded cooling system prevents boil-off at higher volumes.',
    type: PartType.MINING_MODULE,
    reliability: RELIABILITY_TIERS.MID,
    mass: 700,
    cost: 55_000,
