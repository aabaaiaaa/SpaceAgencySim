/**
 * debugSaves/definitions.ts — Pre-built game state snapshots for manual testing.
 *
 * Each generator returns a fully formed GameState at a specific progression
 * point.  The debug save menu (src/ui/debugSaves.ts) loads these into the
...
import { LATE_GAME_STAGES } from './lateGameStages.ts';
import {
  STARTING_MONEY,
  GameMode,
  MissionState,
...
export const DEBUG_SAVE_DEFINITIONS: DebugSaveDefinition[] = [
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.CREW_ADMIN] = { built: true, tier: 1 };
      s.sciencePoints = 25;
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.CREW_ADMIN] = { built: true, tier: 1 }; s.hubs[0].facilities[FacilityId.RD_LAB] = { built: true, tier: 1 };
      s.sciencePoints = 60;
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.CREW_ADMIN] = { built: true, tier: 1 }; s.hubs[0].facilities[FacilityId.RD_LAB] = { built: true, tier: 1 }; s.hubs[0].facilities[FacilityId.TRACKING_STATION] = { built: true, tier: 1 };
      s.sciencePoints = 100;
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.CREW_ADMIN]={built:true,tier:2};s.hubs[0].facilities[FacilityId.RD_LAB]={built:true,tier:2};s.hubs[0].facilities[FacilityId.TRACKING_STATION]={built:true,tier:2};s.hubs[0].facilities[FacilityId.SATELLITE_OPS]={built:true,tier:1};s.hubs[0].facilities[FacilityId.LIBRARY]={built:true,tier:1};
      s.sciencePoints = 180;
      ...
      s.satelliteNetwork = { satellites: [{id:'sat-rec-001',orbitalObjectId:'sat-obj-001',satelliteType:SatelliteType.COMMUNICATION,partId:'satellite-comm',bodyId:'EARTH',bandId:'LEO',health:95,autoMaintain:true,deployedPeriod:22},{id:'sat-rec-002',orbitalObjectId:'sat-obj-002',satelliteType:SatelliteType.GPS,partId:'satellite-gps',bodyId:'EARTH',bandId:'LEO',health:100,autoMaintain:false,deployedPeriod:30}] };
      s.contracts = { board: [], active: [], completed: [{id:'contract-d-001',title:'Suborbital Science',description:'',category:ContractCategory.SCIENCE_SURVEY,objectives:[],reward:40_000,penaltyFee:0,reputationReward:3,reputationPenalty:0,deadlinePeriod:null,boardExpiryPeriod:50,generatedPeriod:10,acceptedPeriod:12,chainId:null,chainPart:null,chainTotal:null}], failed: [] };
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.LAUNCH_PAD]={built:true,tier:3};s.hubs[0].facilities[FacilityId.VAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.MISSION_CONTROL]={built:true,tier:3};s.hubs[0].facilities[FacilityId.CREW_ADMIN]={built:true,tier:3};s.hubs[0].facilities[FacilityId.RD_LAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.TRACKING_STATION]={built:true,tier:3};s.hubs[0].facilities[FacilityId.SATELLITE_OPS]={built:true,tier:2};s.hubs[0].facilities[FacilityId.LIBRARY]={built:true,tier:1};
      s.sciencePoints = 350;
      ...
      s.savedDesigns = [{id:'design-001',name:'Explorer I',totalMass:2500} as Partial<RocketDesign> as RocketDesign,{id:'design-002',name:'Lifter II',totalMass:8500} as Partial<RocketDesign> as RocketDesign,{id:'design-003',name:'Orbital III',totalMass:15000} as Partial<RocketDesign> as RocketDesign];
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.LAUNCH_PAD]={built:true,tier:3};s.hubs[0].facilities[FacilityId.VAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.MISSION_CONTROL]={built:true,tier:3};s.hubs[0].facilities[FacilityId.CREW_ADMIN]={built:true,tier:3};s.hubs[0].facilities[FacilityId.RD_LAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.TRACKING_STATION]={built:true,tier:3};s.hubs[0].facilities[FacilityId.SATELLITE_OPS]={built:true,tier:3};s.hubs[0].facilities[FacilityId.LIBRARY]={built:true,tier:1};
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.LAUNCH_PAD]={built:true,tier:3};s.hubs[0].facilities[FacilityId.VAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.MISSION_CONTROL]={built:true,tier:3};s.hubs[0].facilities[FacilityId.CREW_ADMIN]={built:true,tier:2};s.hubs[0].facilities[FacilityId.RD_LAB]={built:true,tier:3};s.hubs[0].facilities[FacilityId.TRACKING_STATION]={built:true,tier:3};s.hubs[0].facilities[FacilityId.SATELLITE_OPS]={built:true,tier:2};s.hubs[0].facilities[FacilityId.LIBRARY]={built:true,tier:1};
      s.sciencePoints = 280;
...

  {
    ...
    generate() {
      ...
      s.hubs[0].facilities[FacilityId.LAUNCH_PAD]={built:true,tier:2};s.hubs[0].facilities[FacilityId.VAB]={built:true,tier:2};s.hubs[0].facilities[FacilityId.MISSION_CONTROL]={built:true,tier:2};s.hubs[0].facilities[FacilityId.CREW_ADMIN]={built:true,tier:1};s.hubs[0].facilities[FacilityId.RD_LAB]={built:true,tier:1};s.hubs[0].facilities[FacilityId.TRACKING_STATION]={built:true,tier:1};
      s.sciencePoints = 80;
      ...
      s.contracts = {
        board: [{id:'contract-b-001',title:'Orbital Survey Delta',description:'Perform an orbital science survey.',category:ContractCategory.SCIENCE_SURVEY,objectives:[],reward:80_000,penaltyFee:10_000,reputationReward:5,reputationPenalty:2,deadlinePeriod:35,boardExpiryPeriod:30,generatedPeriod:24,acceptedPeriod:null,chainId:null,chainPart:null,chainTotal:null}],
        active: [{id:'contract-a-001',title:'Deploy Comm Satellite',description:'Deploy a communications satellite to LEO.',category:ContractCategory.SATELLITE_DEPLOY,objectives:[],reward:120_000,penaltyFee:15_000,reputationReward:4,reputationPenalty:3,deadlinePeriod:40,boardExpiryPeriod:28,generatedPeriod:20,acceptedPeriod:25,chainId:null,chainPart:null,chainTotal:null}],
        completed: [], failed: [],
      };
      ...
      s.satelliteNetwork = { satellites: [{id:'sat-rec-001',orbitalObjectId:'sat-obj-001',satelliteType:SatelliteType.COMMUNICATION,partId:'satellite-comm',bodyId:'EARTH',bandId:'LEO',health:92,autoMaintain:false,deployedPeriod:18}] };
  ...
  // === LATE GAME — INTERPLANETARY (Stages A–F) ===
  ...LATE_GAME_STAGES,
];
