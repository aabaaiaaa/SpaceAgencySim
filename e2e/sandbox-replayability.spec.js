...
test.describe('Sandbox mode', () => {
  ...
  test('sandbox save has unlimited money and all parts unlocked', async () => {
    ...
    // buildSaveEnvelope doesn't include gameMode/sandboxSettings — inject directly.
  ...
  test('sandbox save has all facilities built', async () => {
    const gs = await getGameState(page);
    const facilityIds = [
  ...
  test('sandbox malfunction toggle stored in state', async () => {
    const gs = await getGameState(page);
  ...
  test('sandbox flight works with malfunctions disabled', async () => {
  ...
  test('sandbox and career can share design library via state', async () => {
    const gs = await getGameState(page);
...
test.describe('Challenge missions', () => {
  ...
  test.beforeAll(async ({ browser }) => {
    ...
    // Use an orbital fixture with mission-004 completed (to unlock most challenges).
  ...
  test('challenges tab displays unlocked challenges in Mission Control', async () => {
  ...
  test('challenge card shows objectives, medal thresholds, and scoring info', async () => {
  ...
  test('accept challenge stores it in state.challenges.active', async () => {
  ...
  test('active challenge shows Active badge and Abandon button', async () => {
  ...
  test('abandon challenge clears active slot', async () => {
    const activeCard = page.locator('.mc-challenge-card.active-challenge');
  ...
  test('challenge scoring and medal award via core API', async () => {
  ...
  test('replaying challenge shows Replay button and increments attempts', async () => {
  ...
  test('close Mission Control and return to hub', async () => {
...
test.describe('Custom mission creator', () => {
  ...
  test('custom challenge creation via core API', async () => {
    const result = await page.evaluate(() => {
      const state = window.__gameState;
  ...
  test('custom challenge appears in Challenges tab with custom badge', async () => {
    await page.click('[data-building-id="mission-control"]');
    await page.waitForSelector('#mission-control-overlay', { state: 'visible', timeout: 10_000 });
  ...
  test('custom challenge has Export and Delete buttons', async () => {
  ...
  test('objective type selection available in creator form', async () => {
  ...
  test('creator form has medal threshold and reward inputs', async () => {
  ...
  test('creator form has score metric selector', async () => {
  ...
  test('creating a custom challenge via the form adds it to state', async () => {
    // Fill the form
  ...
  test('export custom challenge produces valid JSON', async () => {
  ...
  test('import custom challenge from JSON adds it to state', async () => {
  ...
  test('delete custom challenge removes it from state', async () => {
  ...
  test('close Mission Control', async () => {
    await page.click('#mission-control-back-btn');
    await page.waitForSelector('#hub-overlay', { state: 'visible', timeout: 10_000 });
  });
});
...
test.describe('Game settings — difficulty options', () => {
  ...
  test('changing malfunction frequency to Off updates state', async () => {
  ...
  test('changing malfunction frequency to High updates state', async () => {
  ...
  test('changing weather severity to Off updates state', async () => {
  ...
  test('changing weather severity to Extreme updates state', async () => {
  ...
  test('changing financial pressure to Easy updates state', async () => {
  ...
  test('changing financial pressure to Hard updates state', async () => {
  ...
  test('changing crew injury duration to Short updates state', async () => {
  ...
  test('changing crew injury duration to Long updates state', async () => {
  ...
  test('settings changes take effect immediately (no restart needed)', async () => {
  ...
  test('back to hub button closes settings panel', async () => {
  ...
  test('save slot summary does NOT contain difficulty settings', async () => {
...
test.describe('Difficulty settings modify gameplay values', () => {
  ...
  test('malfunction frequency multiplier: off = 0, low = 0.4, normal = 1, high = 2', async () => {
    const envelope = buildSaveEnvelope({
      saveName: 'Malf Test',
      parts: ALL_PARTS,
      tutorialMode: false,
  ...
  test('weather severity multiplier mapping is correct', async () => {
    const results = await page.evaluate(() => {
      const expected = {
  ...
  test('financial pressure multiplier mapping is correct', async () => {
    const results = await page.evaluate(() => {
      const expected = {
  ...
  test('injury duration multiplier mapping is correct', async () => {
    const results = await page.evaluate(() => {
